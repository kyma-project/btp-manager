...
//+kubebuilder:rbac:groups="",resources="configmaps",verbs=get;list;watch;update;deletecollection
//+kubebuilder:rbac:groups="",resources="configmaps/status",verbs=get;update;patch
//+kubebuilder:rbac:groups="",resources="secrets",verbs=create;get;list;watch;update;patch;delete;deletecollection
