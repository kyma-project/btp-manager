...
func TestBtpOperatorReconciler_UpdateBtpOperatorStatus(t *testing.T) {
	...
	t.Run("should return error from client.Get", func(t *testing.T) {
		...
		btpOperatorReconciler := NewBtpOperatorReconciler(retryK8sClient, fakeK8sClient, scheme, nil, nil, nil, nil, []config.WatchHandler{})
	...
	t.Run("should time out", func(t *testing.T) {
		...
		btpOperatorReconciler := NewBtpOperatorReconciler(disabledUpdatek8sClient, fakeK8sClient, scheme, nil, nil, nil, nil, []config.WatchHandler{})
