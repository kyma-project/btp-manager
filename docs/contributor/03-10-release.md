...
13. If the unit tests, stress tests, and E2E tests are completed successfully (and you did not choose to not publish in 1.vii), the GitHub action publishes the release.
