...
| 5                    | Processing           | Ready                | false                | LeaderCrRotation                                | Selected new BtpOperator as a leading one                                                     |
...
| 8                    | Processing           | Ready                | false                | Updated                                         | Resource has been updated                                                                     |
| 9                    | Deleting             | Ready                | false                | HardDeleting                                    | Trying to hard delete                                                                         |
| 10                   | Deleting             | Ready                | false                | ServiceInstancesAndBindingsNotCleaned           | Deprovisioning blocked because of ServiceInstances and/or ServiceBindings existence           |
| 11                   | Deleting             | Ready                | false                | SoftDeleting                                    | Trying to soft delete after hard delete failed                                                |
| 12                   | Error                | Ready                | false                | ChartInstallFailed                              | Failure during chart installation                                                             |
| 13                   | Error                | Ready                | false                | ChartPathEmpty                                  | No chart path available for processing                                                        |
| 14                   | Error                | Ready                | false                | ConsistencyCheckFailed                          | Failure during consistency check                                                              |
| 15                   | Error                | Ready                | false                | DeletionOfOrphanedResourcesFailed               | Deletion of orphaned resources failed                                                         |
| 16                   | Error                | Ready                | false                | GettingConfigMapFailed                          | Getting Config Map failed                                                                     |
| 17                   | Error                | Ready                | false                | InconsistentChart                               | Chart is inconsistent. Reconciliation initialized                                             |
| 18                   | Error                | Ready                | false                | InvalidSecret                                   | sap-btp-manager secret does not contain required data - create proper secret                  |
...
| 25                   | Warning              | Ready                | false                | MissingSecret                                   | sap-btp-manager secret was not found - create proper secret                                   |
