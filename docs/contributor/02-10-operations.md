...
Next, the reconciler looks for a `sap-btp-manager` Secret in the `kyma-system` Namespace with label `app.kubernetes.io/managed-by: btp-manager`. This Secret contains Service
