...
Regardless of the method, you must create Secrets in the managed namespace. By default, it is the `kyma-system` namespace. If you want to customize your managed namespace, follow the intructions in [Customize the Default Credentials and Access](03-11-customize_secret.md).
