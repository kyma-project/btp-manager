        ...
        return (
            <>
                <div className="margin-wrapper">
                    <ui5.ShellBar
                        style={{ borderRadius: "var(--_ui5-v1-24-7_side_navigation_border_radius);" }}
                ...
                <>
                    <div className="margin-wrapper">
                        <ui5.SideNavigation>
                            <ui5.SideNavigationItem
                                text="Marketplace"
                                icon="puzzle"
                                selected={!!matchPath(location.pathname, "/offerings")}
                                onClick={() => {
                                    navigate("/offerings");
                                }}
                            />
                            <ui5.SideNavigationItem
                                ...
                                icon="connected"
                                selected={!!matchPath(location.pathname, "/instances")}
                                onClick={() => {
                                    navigate("/instances");
                                }}
                            ></ui5.SideNavigationItem>
                    ...
                    <div className="margin-wrapper main-column">
                        <ObjectPage
                            ...
                            headerTitle={<SecretsView onSecretChanged={(secret: string) => onSecretChanged(secret)} />}
                        >
                            <Outlet />
                        </ObjectPage>
                    </div>
